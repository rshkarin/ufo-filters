...
#define UFO_IS_FLAT_FIELD_CORRECTION_TASK(obj)          (G_TYPE_CHECK_INSTANCE_TYPE((obj), UFO_TYPE_GR_CORRECTION_TASK))
...
#define UFO_IS_FLAT_FIELD_CORRECTION_TASK_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE((klass), UFO_TYPE_GR_CORRECTION_TASK))
